...
if __name__ == '__main__':
    options = {'swagger_path': '/opt/app-root/lib/python3.6/site-packages/swagger_ui'}
    app = connexion.FlaskApp(__name__, port=8080, specification_dir='swagger/', options=options)
